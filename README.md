...
<a href="https://pkg.go.dev/github.com/stainless-sdks/hypeman-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/hypeman-go.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/stainless-sdks/hypeman-go" // imported as hypeman
)
```
...
```sh
go get -u 'github.com/stainless-sdks/hypeman-go@v0.0.1'
```
...
The hypeman library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/hypeman-go/option).
...
`*hypeman.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/hypeman-go/issues) with questions, bugs, or suggestions.
